...
ship-flagpole-color-pirate = Веселый Роджер
ship-flagpole-color-legion = Легион
ship-flagpole-color-insurgency = Мятеж
ship-flagpole-color-collegium = Коллегия
ship-flagpole-color-mercenary = Наемники
