treasure-map-coordinates = Numbers are drawn on the map: {$x}, {$y}
treasure-map-empty = This sheet of paper is blank.
treasure-dig-found = You have stumbled upon something!
