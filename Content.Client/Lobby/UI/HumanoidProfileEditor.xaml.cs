...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
            ...
            Imperial.Medieval.Flavors.ClientFlavorManager flavors, Shared.Players.PlayTimeTracking.ISharedPlaytimeManager playtime) // Imperial Medieval Flavor Images
        {
            ...
            TabContainer.SetTabTitle(2, Loc.GetString("humanoid-profile-editor-jobs-tab")); // imperial medieval languages: tab 1 -> 2
            ...
            TabContainer.SetTabTitle(3, Loc.GetString("humanoid-profile-editor-antags-tab"));   // imperial medieval languages: tab 2 -> 3

            RefreshTraits();

            #region Markings

            TabContainer.SetTabTitle(5, Loc.GetString("humanoid-profile-editor-markings-tab")); // imperial medieval languages: tab 4 -> 5
        ...
        public void RefreshTraits()
        {
            ...
            TabContainer.SetTabTitle(4, Loc.GetString("humanoid-profile-editor-traits-tab"));   // imperial medieval languages: tab 3 -> 4
        ...
        public void RefreshJobs()
        {
            ...
            foreach (var department in departments)
            {
                ...
                if (!_jobCategories.TryGetValue(department.ID, out var category))
                {
                    ...
                    {
                        PanelOverride = new StyleBoxFlat {BackgroundColor = Color.FromHex("#41332F")},
                        Children =
                        {
                            new Label
                            {
